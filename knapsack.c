/*
 *
   Mark Sattolo (mh.satto@gmail.com)
 -----------------------------------------------
   File: @(#)knapsack.c
   Version: 1.23
...
int bestFirstSearch( const nodeArray pw, const int n, const int W, const int maxItems, int *tw, char **best )
{
  int i = 0; // loop count
